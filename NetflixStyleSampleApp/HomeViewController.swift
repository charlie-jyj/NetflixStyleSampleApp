...
class HomeViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        self.mainItem = self.contents.first?.contentItem.randomElement()
        ...
        // layout 설정
        collectionView.collectionViewLayout = layout()  // sceneDelegate에 있던 layout 을 대체
    }
...
extension HomeViewController {
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        case 0:
            return 1
        default:
            return self.contents[section].contentItem.count
        }
    }
    
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        switch self.contents[indexPath.section].sectionType {
        case .basic, .large:
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == UICollectionView.elementKindSectionHeader {
            ...
            headerView.sectionNameLabel.text = self.contents[indexPath.section].sectionName
            return headerView
        } else {
...
struct HomeViewController_Previews: PreviewProvider {
    static var previews: some View {
        HomeViewControllerRepresentable().edgesIgnoringSafeArea(/*@START_MENU_TOKEN@*/.all/*@END_MENU_TOKEN@*/)
    }
}
